...
<head>
    ...
    <title>Forgot Password · Onboarding</title>
    ...
    <style>
        * {
        ...
        /* Exact font sizes from login page */
        .left-heading {
...
<div class="w-full max-w-7xl h-auto lg:h-[calc(100vh-48px)] flex flex-col lg:flex-row rounded-[28px] overflow-hidden bg-white shadow-2xl mx-auto">
    ...
    <div class="relative lg:flex lg:w-[58%] flex-col overflow-hidden px-6 sm:px-10 lg:px-14 pt-8 lg:pt-12 pb-0 bg-cover bg-center bg-no-repeat"
        ...
        <!-- footer (left) -->
        <div class="absolute left-14 bottom-6 text-xs sm:text-sm text-[#5B6478] z-30">
    ...
    <div class="w-full lg:w-[42%] flex items-center justify-center px-4 sm:px-6 py-10 lg:py-12 bg-[#F8FAFD]">
        <div class="card-padding w-full max-w-[470px] bg-white rounded-[22px] border border-[#EDF1F7] shadow-[0_15px_50px_rgba(33,67,135,.08)] px-6 sm:px-10 py-8 sm:py-9">
            ...
            <div class="text-center">
                <h2 class="welcome-title text-3xl sm:text-[36px] font-bold text-[#1E293B]">Forgot Password?</h2>
                <p class="welcome-sub mt-3 text-[15px] sm:text-[17px] text-[#64748B]">
                    Enter your email address and we'll send you a link to reset your password.
                </p>
            </div>

            <!-- FORM -->
            <form method="POST" action="{{ route('password.email') }}" class="mt-8 sm:mt-10">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative mt-3">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="you@example.com" class="input-style" required />
                    </div>
                    @error('email')
                ...
                <!-- Submit Button -->
                <button type="submit" class="login-btn mt-8">Send Reset Link</button>

                <!-- Back to Login -->
                <div class="text-center mt-6">
                    <a href="{{ route('login') }}" class="text-blue-600 font-medium hover:underline text-sm">
                        Back to Login
                    </a>
                </div>
