<x-client-layout title="{{ $course->title }}">
    <nav class="flex items-center gap-2 text-sm text-secondary">
        <a href="{{ route('client.courses.index') }}" class="hover:text-primary">Courses</a>
    ...
    <div class="mt-3 flex items-start gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-secondary">{{ $course->product?->name }}</p>
        </div>
    </div>
    ...
    @include('client.courses._player')
</x-client-layout>
