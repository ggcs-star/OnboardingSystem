...
>
    <div class="flex items-center justify-between px-4 py-5">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 overflow-hidden" :class="collapsed && 'justify-center w-full'">
            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary text-white font-bold">
                A
            </span>
            <span x-show="!collapsed" x-cloak class="text-lg font-semibold text-secondary-dark whitespace-nowrap">
                Admin
            </span>
        </a>
